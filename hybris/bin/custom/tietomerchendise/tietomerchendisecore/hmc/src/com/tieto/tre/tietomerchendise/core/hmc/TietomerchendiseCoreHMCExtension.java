 ...
 *
 */
package com.tieto.tre.tietomerchendise.core.hmc;
...
/**
 * Provides necessary meta information about the tietomerchendisecore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class TietomerchendiseCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(TietomerchendiseCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.tieto.tre.tietomerchendise.core.hmc.locales";

 ...
 *
 */
package com.tieto.tre.tietomerchendise.test.setup;
...
import com.tieto.tre.tietomerchendise.test.constants.TietomerchendiseTestConstants;
import com.tieto.tre.tietomerchendise.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TietomerchendiseTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/tietomerchendisetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/tietomerchendisetest/import/reviews.impex");
			...
			importImpexFile(context, "/tietomerchendisetest/import/cstickets.impex");
		}
	}
}

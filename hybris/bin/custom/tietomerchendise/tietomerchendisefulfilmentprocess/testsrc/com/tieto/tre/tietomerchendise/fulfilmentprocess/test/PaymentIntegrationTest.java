...
import com.tieto.tre.tietomerchendise.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/tietomerchendisefulfilmentprocess/test/tietomerchendisefulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/tietomerchendisefulfilmentprocess/test/tietomerchendisefulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/tietomerchendisefulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/tietomerchendisefulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/tietomerchendisefulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/tietomerchendisefulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/tietomerchendisefulfilmentprocess/test/tietomerchendisefulfilmentprocess-spring-testcleanup.xml"));

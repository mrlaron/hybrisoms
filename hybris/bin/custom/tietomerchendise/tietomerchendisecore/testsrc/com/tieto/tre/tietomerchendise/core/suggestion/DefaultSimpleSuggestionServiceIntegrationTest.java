 ...
 *
 */
package com.tieto.tre.tietomerchendise.core.suggestion;
...
import com.tieto.tre.tietomerchendise.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/tietomerchendisecore/test/testSimpleSuggestionService.csv", "utf-8");
	}

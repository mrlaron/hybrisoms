package com.tieto.tre.integration;
...
import com.tieto.tre.actions.order.SourceOrderAction;
...
public class CancellationIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void setup() throws IOException, ImpExException
	{
		...
		importCsv("/tietomerchendiseoms/test/impex/integration-test-data-default.impex", WarehousingTestConstants.ENCODING);
		importCsv("/tietomerchendiseoms/test/impex/integration-test-data-simple.impex", WarehousingTestConstants.ENCODING);
	...
	public void cancelConsignmentEntrySuccess()
	{
		...
		final OrderProcessModel process = getBusinessProcessService().<OrderProcessModel> createProcess(
				order.getCode() + "_ordermanagement", TietomerchendiseomsConstants.ORDER_PROCESS_NAME);

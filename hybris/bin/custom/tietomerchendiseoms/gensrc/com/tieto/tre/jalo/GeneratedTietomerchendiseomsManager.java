 ...
 * --- Generated at 2015-okt-28 17:59:53                        ---
 * ----------------------------------------------------------------
 *  
 * [y] hybris Platform
 *  
...
/**
 * Generated class for type <code>TietomerchendiseomsManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedTietomerchendiseomsManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, TietomerchendiseomsConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, TietomerchendiseomsConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return TietomerchendiseomsConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, TietomerchendiseomsConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, TietomerchendiseomsConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, TietomerchendiseomsConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, TietomerchendiseomsConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}

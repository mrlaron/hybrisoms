 ...
 *
 */
package com.tieto.tre.tietomerchendise.fulfilmentprocess.test.jobs;
...
import com.tieto.tre.tietomerchendise.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = TietomerchendiseFulfilmentProcessConstants.ORDER_PROCESS_NAME;

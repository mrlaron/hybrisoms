 ...
 *
 */
package com.tieto.tre.tietomerchendise.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, TietomerchendiseFulfilmentProcessConstants.PARENT_PROCESS);

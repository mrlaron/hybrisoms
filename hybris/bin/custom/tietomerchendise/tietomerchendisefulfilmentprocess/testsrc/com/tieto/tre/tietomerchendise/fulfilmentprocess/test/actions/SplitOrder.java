...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(TietomerchendiseFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TietomerchendiseFulfilmentProcessConstants.PARENT_PROCESS);

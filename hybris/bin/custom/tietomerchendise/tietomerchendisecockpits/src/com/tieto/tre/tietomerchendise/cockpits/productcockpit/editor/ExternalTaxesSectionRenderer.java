 ...
 *
 */
package com.tieto.tre.tietomerchendise.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("tietomerchendisecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("tietomerchendisecockpits.product.externalTaxes"));
